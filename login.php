...
<style type="text/css">
    ...
    <title> Hotel Beni Hamad | Login </title>
  </head>
         ...
         if ($stmt->rowCount() > 0) {
          ...
          <div  class="alert alert-danger">
              ...
              Name Or password Not valid </p>
               ...
               $stmt = $conn->prepare("INSERT INTO users (username, email, pass, add_date)
                                       VALUES (?, ?, ?, now())"); 
               ...
               if ($stmt) {
                 ...
                 <?php
                    //  echo "Welcome " . $row['username'] . '<br>';
                     ...
                     echo "You are Signup successfuly";           
                 ?>
                   </div>
                 <?php
                       $_SESSION['username'] = $row['username']; // Register session name
                   ...
                   <div  class="alert alert-danger">
                       ...
                       style="color: red; "
                       > 
                       Name Or Password Or Email Not valid </p>
                    </div>';
                }
          }
  }
      ...
      <div class="forms-container">
        <div class="signin-signup">
          <form action="<?= $_SERVER['PHP_SELF'];?>"  method="post" class="sign-in-form">
            ...
            <input type="submit" name="connecter" value="connecter" class="btn solid" />
            <p class="social-text">Ou</p>
            <div class="social-media">
              <a href="http://www.facebook.com" target="_blank" class="social-icon">
                <i class="fab fa-facebook-f"></i>
              </a>
              <a href="https://twitter.com/i/flow/login" target="_blank" class="social-icon">
                <i class="fab fa-twitter"></i>
              </a>
              <a href="https://mail.google.com/" target="_blank" class="social-icon">
                <i class="fab fa-google"></i>
              </a>
              <a href="https://www.linkedin.com/login/fr" target="_blank" class="social-icon">
      ...
      <div class="panels-container">
        <div class="panel left-panel">
          <div class="content">
            <h3>Nouveau ici ?</h3>
            <p>
              Si vous n'avez pas de compte, n'hésitez pas à vous inscrire
            </p>
